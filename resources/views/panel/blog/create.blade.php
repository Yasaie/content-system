...
<ol class="breadcrumb">
    ...
    <li class="active">ایجاد کردن مطلب جدید</li>
</ol>

<div class="row">
    <form class="form" method="POST" action="{{ route('panel.blog.store') }}" enctype="multipart/form-data">
        <div class="col-lg-8">
            <div class="card-box">
                <h4 class="text-dark header-title m-t-0">ایجاد مطلب جدید</h4>
                <hr>
                @csrf
                <div class="row">
                    ...
                    <div class="form-group {{ $errors->has('categories') ? 'has-error' : '' }} col-md-12">
                        ...
                        @foreach($categories as $category)
                            <div class="checkbox checkbox-primary">
                                <input name="categories[]" value="{{ $category->id }}" type="checkbox" id="category-{{ $category->id }}">
