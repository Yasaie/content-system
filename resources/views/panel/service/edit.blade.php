...
<ol class="breadcrumb">
    ...
    <li class="active">ویرایش خدمات</li>
</ol>

<div class="row">
    <form class="form" method="POST" action="{{ route('panel.service.update',$service) }}" enctype="multipart/form-data">
        <div class="col-lg-8">
            <div class="card-box">
                <h4 class="text-dark header-title m-t-0">ویرایش خدمات</h4>
                <hr>
                @csrf
                @method('PATCH')
                <div class="row">
                    <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }} col-md-12">
                        ...
                        <input id="title" name="title" class="form-control" placeholder="عنوان" value="{{ $service->title ?? old('title') }}" type="text">
                        @if($errors->has('title'))
                            <div>
                    ...
                    <div class="form-group {{ $errors->has('body') ? 'has-error' : '' }} col-md-12">
                        ...
                        <textarea id="body" name="body" class="form-control" placeholder="محتوا" cols="30" rows="10">{!! $service->body ?? old('body') !!}</textarea>
                        @if($errors->has('body'))
                            <div>
                                <strong class="help-block text-danger">
                                    {{ $errors->first('body') }}
                ...
                <div class="row">
                    <div class="form-group {{ $errors->has('meta_excerpt') ? 'has-error' : '' }} col-md-12">
                        ...
                        <input id="meta_excerpt" name="meta_excerpt" class="form-control" placeholder="توضیحات مختصر" value="{{ $service->meta_excerpt ?? old('meta_excerpt') }}" type="text">
            ...
            <div class="card-box">
                ...
                <div class="row">
                    <div class="form-group {{ $errors->has('seo_title') ? 'has-error' : '' }} col-md-12">
                        ...
                        <input id="seo_title" name="seo_title" class="form-control" placeholder="عنوان در تگ title قرار میگیرد" value="{{ $service->seo->title ?? old('seo_title') }}" type="text">
                    ...
                    <div class="form-group {{ $errors->has('seo_description') ? 'has-error' : '' }} col-md-12">
                        ...
                        <input id="seo_description" name="seo_description" class="form-control" placeholder="توضیحات در متا تگ description قرار میگیرد" value="{{ $service->seo->description ?? old('seo_description') }}" type="text">
                    ...
                    <div class="form-group {{ $errors->has('seo_keywords') ? 'has-error' : '' }} col-md-12">
                        ...
                        <input id="seo_keywords" name="seo_keywords" class="form-control" placeholder="کلمات کلیدی در تگ meta قرار میگیرند" value="{{ $service->seo->keywords ?? old('seo_keywords') }}" type="text">
                    ...
                    <div class="form-group {{ $errors->has('seo_canonical') ? 'has-error' : '' }} col-md-12">
                        ...
                        <input id="seo_canonical" name="seo_canonical" class="form-control" placeholder="لینک در متا تگ canonical قرار میگیرد" value="{{ $service->seo->canonical ??  old('seo_canonical') }}" type="text">
                ...
                <div class="row">
                    <div class="form-group {{ $errors->has('publish') ? 'has-error' : '' }} col-md-12">
                        ...
                        <select id="publish" name="publish" class="form-control">
                            <option {{ ($service->published() ? 'selected' : '') }} value="1">انتشار بده</option>
                            <option {{ ($service->notPublished() ? 'selected' : '') }} value="0">پیش نویس کن</option>
                        </select>
                    ...
                    <div class="form-group {{ $errors->has('media') ? 'has-error' : '' }} col-md-12">
                        ...
                        @if(!empty($service->image))
                            <div>
                                <img class="img-responsive thumbnail" src="{{ fileUploadUrl($service->image) }}">
                            </div>
                        @endif
