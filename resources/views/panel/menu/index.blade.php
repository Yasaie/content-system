...
<ol class="breadcrumb">
    ...
    <li class="active">منوها</li>
</ol>

<div class="row">
    <div class="col-lg-12">
        <div class="card-box">
            <h4 class="text-dark header-title m-t-0">مدیریت منوها</h4>
            <hr>
            <div class="row">
                <div class="col-md-12">
                    @if($menu)
            ...
            <div class="modal fade" id="newModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form method="POST" class="form-horizontal" action="{{ route('panel.menu.store') }}">
                            @csrf
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <label for="url" class="col-lg-2 control-label">آدرس (url)</label>
                                    <div class="col-lg-10">
                                        <input name="url" class="form-control" type="url" required>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form method="POST" action="{{ url('panel/menu/delete') }}">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
