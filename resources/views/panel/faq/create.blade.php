...
<ol class="breadcrumb">
    ...
    <li class="active">ثبت پرسش و پاسخ</li>
</ol>

<div class="row">
    <div class="col-lg-12">
        <div class="card-box">
            <h4 class="text-dark header-title m-t-0">ایجاد پرسش و پاسخ جدید</h4>
            <hr>
            <form class="form" method="POST" action="{{ route('panel.faq.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="form-group {{ $errors->has('question') ? 'has-error' : '' }} col-md-12">
                        <label class="control-label" for="question">پرسش</label>
                        <textarea name="question" id="question" class="form-control" placeholder="پرسش" cols="30" rows="10">{{ old('question') }}</textarea>
                ...
                <div class="row">
                    <div class="form-group {{ $errors->has('answer') ? 'has-error' : '' }} col-md-12">
                        ...
                        <textarea name="answer" id="answer" class="form-control" placeholder="پاسخ" cols="30" rows="10">{{ old('answer') }}</textarea>
