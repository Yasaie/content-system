...
<div class="row">
    <form class="form" method="POST" action="{{ route('panel.page.store') }}" enctype="multipart/form-data">
        <div class="col-lg-8">
            <div class="card-box">
                <h4 class="text-dark header-title m-t-0">ایجاد صفحه جدید</h4>
                <hr>
                @csrf
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div id="mainShowFields">
                        ...
                        <div v-if="mainShow==1" v-cloak class="form-group {{ $errors->has('meta_tabtitle') ? 'has-error' : '' }} col-md-12">
                            ...
                            <input id="meta_tabtitle" name="meta_tabtitle" class="form-control" placeholder="عنوان تب در صفحه اول" value="{{ old('meta_tabtitle') }}" type="text" required>
